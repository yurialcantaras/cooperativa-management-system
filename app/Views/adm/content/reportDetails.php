            ...
            <div class="row justify-content-center">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo $titleDetails; ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td style="text-align: end;">Tipo</td>
                                    <td><?php echo $titleDetails; ?></td>
                                </tr>
                                <tr>
                ...
                <div id="new-title" class="card title-description col-7" style="display: none;">
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $titleDetails; ?></h3>
                        <button onclick="closeNewTitle()" type="button" class="btn btn-tool float-right pt-2" data-card-widget="remove">
                            <i class="fas fa-times"></i>
                        </button>
                    </div>
                    <form method="post" action="<?php echo base_url('/bookstockcontroller/titleedit?id=' . $titleDetails); ?>">
                        <div class="form-check d-flex justify-content-center">
                            <div class="justify-content-center form-check form-check-inline col-sm-3 bg-olive p-2">
                                <input <?php echo ($titleDetails == 'Kit') ? "checked" : ""; ?> value="1" type="radio" name="type" class="form-check-input" id="kit-type" style="width: 15px; height: 15px;" require>
                            ...
                            <div class="justify-content-center form-check form-check-inline col-sm-3 bg-info p-2">
                                <input <?php echo ($titleDetails == 'Livro') ? "checked" : ""; ?> value="0" type="radio" name="type" class="form-check-input" id="book-type" style="width: 15px; height: 15px;" require>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input name="book_name" type="text" class="form-control" id="book-name" value="<?php echo $titleDetails; ?>" placeholder="Informe o nome do título" require>
                            </div>
                            <div class="form-group">
                                <label for="quantity">Quantidade</label>
                                <input name="quantity" type="number" class="form-control" id="quantity" value="<?php echo $titleDetails; ?>" placeholder="Apenas o número" require>
                            </div>
                            <!-- Date -->
                            <div class="form-group">
                                <label>Date de Chegada</label>
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input id="date" name="arrived_date" type="text" class="form-control datetimepicker-input" value="<?php echo $titleDetails; ?>" data-target="#reservationdate" require />
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="observations" type="text" class="form-control" value="<?php echo $titleDetails; ?>" placeholder="Pequena observação (Não obrigatório)" />
                                </div>
                            </div>
